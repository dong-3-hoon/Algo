def counting_sort_asc(A, B, k):
    ...
    for i in range(1, len(C)):
        ...
        # i 번째 원소가 최소 몇번째부터 등장하게 되는지 (결과 배열의 자리를) 알수 있게 된다.
        C[i] += C[i - 1]

    # 3. 뒤에서부터 A 를 확인하면서 자리를 확인하고 채워 준다.
...
nums = [{"name": "김", "num": 0}, {"name": "나", "num": 4}, {"name": "박", "num": 1}, {"name": "이", "num": 3},
        {"name": "정", "num": 1}, {"name": "홍", "num": 2}, {"name": "신", "num": 4}, {"name": "양", "num": 1}]
result_asc = [0] * 8

counting_sort_asc(nums, result_asc, 4)
